            ...
            <div class="hero-copy relative w-full min-w-0 max-w-xl">
                ...
                <div style="--hero-delay: 360ms" class="hero-in mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                    @if($heroPrimaryIsDefault)
                        <x-healthengine-button :label="$heroPrimaryIcon . e($hero['primary_button_text'] ?? 'Book Appointment')" class="btn-book hero-cta btn-lift inline-flex items-center justify-center gap-3 rounded-xl px-6 py-3.5 text-sm font-bold shadow-lg sm:text-base" />
                    @else
