            ...
            <div class="mt-6 rounded-3xl bg-white dark:bg-[#1a1a1a] p-6 shadow-xl">
                <div class="grid gap-5">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-sm text-ink-faint dark:text-white/60">Address</p>
                            <p class="font-medium text-ink dark:text-[#e0e0e0]">{{ setting('address_line1') }}, {{ setting('address_suburb') }}</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-blue-tint dark:bg-white/10 text-brand-blue">
                        ...
                        <div>
                            <p class="text-sm text-ink-faint dark:text-white/60">Phone</p>
                            <p class="font-medium text-ink dark:text-[#e0e0e0]">{{ setting('phone') }}</p>
                        </div>
                    </div>
                    @if(setting('fax'))
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-sm text-ink-faint dark:text-white/60">Fax</p>
                                <p class="font-medium text-ink dark:text-[#e0e0e0]">{{ setting('fax') }}</p>
                            </div>
                        </div>
                    @endif
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-sm text-ink-faint dark:text-white/60">Email</p>
                            <p class="break-all font-medium text-ink dark:text-[#e0e0e0]">{{ setting('contact_email') }}</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-blue-tint dark:bg-white/10 text-brand-blue">
                        ...
                        <div>
                            <p class="text-sm text-ink-faint dark:text-white/60">Opening Hours</p>
                            <p class="whitespace-pre-line font-medium text-ink dark:text-[#e0e0e0]">{{ setting('opening_hours') }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="rounded-3xl bg-white dark:bg-[#1a1a1a] p-8 shadow-xl" data-reveal>
            ...
            <form id="contact-form" method="POST" action="{{ route('contact.store') }}" class="mt-7 grid gap-5">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <label class="block">
                        <span class="font-semibold text-ink dark:text-[#e0e0e0]">Full Name *</span>
                        <input type="text" name="name" value="{{ old('name') }}" required class="mt-2 w-full rounded-xl border border-slate-200 bg-white text-ink dark:border-white/10 dark:bg-white/5 dark:text-[#e0e0e0] dark:placeholder:text-white/30 p-4 focus:border-brand-blue focus:outline-none" placeholder="John Smith">
                        @error('name')<span class="mt-1 block text-sm text-red-600 dark:text-red-400">{{ $message }}</span>@enderror
                    </label>
                    <label class="block">
                        <span class="font-semibold text-ink dark:text-[#e0e0e0]">Email Address *</span>
                        <input type="email" name="email" value="{{ old('email') }}" required class="mt-2 w-full rounded-xl border border-slate-200 bg-white text-ink dark:border-white/10 dark:bg-white/5 dark:text-[#e0e0e0] dark:placeholder:text-white/30 p-4 focus:border-brand-blue focus:outline-none" placeholder="john@email.com">
                        @error('email')<span class="mt-1 block text-sm text-red-600 dark:text-red-400">{{ $message }}</span>@enderror
                    </label>
                </div>
                <label class="block">
                    <span class="font-semibold text-ink dark:text-[#e0e0e0]">Phone Number</span>
                    <input type="text" name="phone" value="{{ old('phone') }}" class="mt-2 w-full rounded-xl border border-slate-200 bg-white text-ink dark:border-white/10 dark:bg-white/5 dark:text-[#e0e0e0] dark:placeholder:text-white/30 p-4 focus:border-brand-blue focus:outline-none" placeholder="0400 000 000">
                </label>
                <label class="block">
                    <span class="font-semibold text-ink dark:text-[#e0e0e0]">Message *</span>
                    <textarea name="message" required class="mt-2 min-h-32 w-full rounded-xl border border-slate-200 bg-white text-ink dark:border-white/10 dark:bg-white/5 dark:text-[#e0e0e0] dark:placeholder:text-white/30 p-4 focus:border-brand-blue focus:outline-none" placeholder="How can we help you?">{{ old('message') }}</textarea>
