...
<section class="bg-gradient-to-br from-brand-blue-darker via-brand-blue-dark to-brand-blue px-6 py-16 text-center">
    ...
    <h1 style="{{ text_style($about['styles'] ?? null, 'heading') }}" class="mx-auto mt-4 max-w-3xl font-serif text-[6vw] font-bold leading-tight text-white sm:text-3xl md:text-4xl">{{ $about['heading'] ?? 'Personalised Support for All Your Healthcare Needs' }}</h1>
...
<section class="px-6 py-24 md:py-28">
    <div class="mx-auto grid max-w-6xl items-center gap-16 md:grid-cols-2 md:gap-20">
        ...
        <div data-reveal>
            <span class="inline-flex items-center rounded-full bg-brand-blue-tint dark:bg-white/10 px-4 py-1.5 text-[12.5px] font-semibold tracking-wide text-ink dark:text-[#e0e0e0]">OUR STORY</span>
            <h2 class="mt-6 font-serif text-3xl font-bold leading-tight text-ink dark:text-[#e0e0e0] md:text-[38px]">A Practice Built on Trust &amp; Community</h2>
            <div style="{{ text_style($about['styles'] ?? null, 'body') }}" class="prose prose-p:mb-4 prose-p:leading-[1.75] prose-p:text-[#5c6b7a] dark:prose-p:text-white/60 dark:text-white/60 mt-6">{!! $about['body'] ?? '' !!}</div>
            ...
            <div class="mt-9 flex flex-wrap gap-4">
                <a href="{{ booking_url() }}" data-book-appointment @if(booking_is_external() && ! setting('healthengine_id')) target="_blank" rel="noopener" @endif class="bg-brand-red text-white hover:bg-brand-red-dark btn-lift inline-flex items-center gap-2 rounded-[9px] px-6 py-3.5 text-[15px] font-semibold">
                ...
                <a href="{{ route('doctors') }}" class="btn-lift inline-flex items-center gap-2 rounded-[9px] border-2 border-ink px-6 py-3.5 text-[15px] font-semibold text-ink hover:bg-ink hover:text-white dark:border-white dark:text-[#e0e0e0] dark:hover:bg-white dark:hover:text-ink">
                    Meet Our Team
...
<section class="bg-brand-blue-tint dark:bg-[#1a1a1a] px-6 py-24 text-center">
    <span class="inline-flex items-center rounded-full bg-white dark:bg-[#1a1a1a] px-4 py-1.5 text-[12.5px] font-semibold tracking-wide text-ink dark:text-[#e0e0e0]">OUR VALUES</span>
    <h2 class="mx-auto mt-5 font-serif text-3xl font-bold text-ink dark:text-[#e0e0e0] md:text-[42px]">What We Stand For</h2>
    ...
    <div class="reveal-stagger mx-auto mt-14 grid max-w-6xl gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <div class="rounded-2xl bg-white dark:bg-[#1a1a1a] p-9 text-left shadow-[0_6px_24px_rgba(20,48,74,0.06)]" data-reveal>
            ...
            <h3 class="font-serif text-lg font-bold text-ink dark:text-[#e0e0e0]">Compassionate Care</h3>
        ...
        <div class="rounded-2xl bg-white dark:bg-[#1a1a1a] p-9 text-left shadow-[0_6px_24px_rgba(20,48,74,0.06)]" data-reveal>
            ...
            <h3 class="font-serif text-lg font-bold text-ink dark:text-[#e0e0e0]">Clinical Excellence</h3>
        ...
        <div class="rounded-2xl bg-white dark:bg-[#1a1a1a] p-9 text-left shadow-[0_6px_24px_rgba(20,48,74,0.06)]" data-reveal>
            ...
            <h3 class="font-serif text-lg font-bold text-ink dark:text-[#e0e0e0]">Community Focus</h3>
        ...
        <div class="rounded-2xl bg-white dark:bg-[#1a1a1a] p-9 text-left shadow-[0_6px_24px_rgba(20,48,74,0.06)]" data-reveal>
            ...
            <h3 class="font-serif text-lg font-bold text-ink dark:text-[#e0e0e0]">Accessibility</h3>
