...
<section class="px-6 py-24">
    ...
    <div class="mx-auto mt-14 max-w-4xl">
        @if(setting('healthengine_id') || setting('healthengine_url'))
            <div class="rounded-3xl bg-brand-blue-tint dark:bg-white/10 p-10 text-center">
        ...
        <div class="mt-8 rounded-2xl bg-amber-50 p-6 text-amber-900 dark:bg-amber-500/10 dark:text-amber-200">
