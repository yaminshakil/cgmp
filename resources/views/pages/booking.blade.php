    ...
    <div class="mx-auto mt-14 max-w-4xl">
        @if(setting('healthengine_id') || setting('healthengine_url'))
            <div data-reveal="zoom" class="rounded-3xl bg-brand-blue-tint dark:bg-white/10 p-10 text-center">
                <h2 class="font-serif text-2xl font-bold text-ink dark:text-[#e0e0e0]">Book Online with HealthEngine</h2>
                <p class="mt-4 leading-7 text-ink-muted dark:text-white/60">See live appointment times and book instantly with our doctors via HealthEngine. You'll be taken to a new tab to complete your booking.</p>
                <div class="mt-7">
                    <x-healthengine-button label="Book Appointment" class="bg-brand-red text-white hover:bg-brand-red-dark inline-flex items-center gap-3 rounded-2xl px-7 py-4 font-bold shadow-lg" />
                </div>
            </div>
        @else
            <div data-reveal="zoom" class="rounded-3xl bg-brand-blue-tint dark:bg-white/10 p-10 text-center">
                <h2 class="font-serif text-2xl font-bold text-ink dark:text-[#e0e0e0]">Online booking coming soon</h2>
                <p class="mt-4 leading-7 text-ink-muted dark:text-white/60">Our online booking widget isn't connected yet. In the meantime, please call the practice to book, or simply walk in — we're open five days a week.</p>
