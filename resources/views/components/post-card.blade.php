...
<article class="rounded-2xl bg-white dark:bg-[#232323] shadow-lg shadow-[#062238]/10 dark:shadow-none dark:border dark:border-white/10 overflow-hidden flex flex-col" data-reveal>
